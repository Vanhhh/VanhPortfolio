        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              />
              <h1 id="colorlib-logo">
                <a href="index.html">Viet Anh Ly</a>
              </h1>
              <span className="email">
                <i className="icon-mail"></i> lyvietanh300994@gmail.com
              </span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li>
                  <a
                    href="https://www.facebook.com/vanhhhhhhhhhhhhhhhhh"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/viet-anh-ly-b14236184/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <div className="colorlib-footer">
              ...
              <p>{/* <small>Something coming soon !!</small> */}</p>
            </div>
          </aside>
        </div>
      </div>
